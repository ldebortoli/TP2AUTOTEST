...
public class FilterIterator_ESTest extends FilterIterator_ESTest_scaffolding {
   ...
   * Goal 17. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 128
   * Goal 18. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 129
   * Goal 19. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 130
   * Goal 20. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 131
   ...
   * Goal 23. [METHOD] collections.iterators.FilterIterator.<init>(Ljava/util/Iterator;)V
   ...
   * Goal 26. [METHODNOEX] collections.iterators.FilterIterator.<init>(Ljava/util/Iterator;)V
   * Goal 27. [METHODNOEX] collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V
   * Goal 28. Weak Mutation 1: collections.iterators.FilterIterator.<init>(Ljava/util/Iterator;)V:24 - ReplaceConstant - 0 -> 1
  ...
  public void test06()  throws Throwable  {
      ...
      Iterator<Object> iterator1 = linkedList1.iterator();
      linkedList1.offerLast(filterIterator0);
