...
public class FilterIterator_ESTest extends FilterIterator_ESTest_scaffolding {
   ...
   * Goal 7. hasNext()Z_java.lang.NullPointerException_IMPLICIT
   ...
   * Goal 10. Branch collections.iterators.FilterIterator.setNextObject()Z: I5 Branch 5 IFEQ L164 - false in context: 
   * Goal 11. hasNext()Z_java.util.ConcurrentModificationException_IMPLICIT
   ...
   * Goal 21. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 128
   * Goal 22. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 129
   * Goal 23. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 130
   * Goal 24. collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V: Line 131
   ...
   * Goal 27. [METHOD] collections.iterators.FilterIterator.<init>()V
   * Goal 28. [METHOD] collections.iterators.FilterIterator.<init>(Ljava/util/Iterator;Lcollections/Predicate;)V
   * Goal 29. [METHOD] collections.iterators.FilterIterator.hasNext()Z
   * Goal 30. [METHOD] collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V
   * Goal 31. [METHODNOEX] collections.iterators.FilterIterator.<init>()V
   ...
   * Goal 34. Weak Mutation 0: collections.iterators.FilterIterator.<init>()V:24 - ReplaceConstant - 0 -> 1
   * Goal 35. Weak Mutation 2: collections.iterators.FilterIterator.<init>(Ljava/util/Iterator;Lcollections/Predicate;)V:24 - ReplaceConstant - 0 -> 1
   * Goal 36. Weak Mutation 3: collections.iterators.FilterIterator.hasNext()Z:69 - InsertUnaryOp Negation
   * Goal 37. Weak Mutation 4: collections.iterators.FilterIterator.hasNext()Z:69 - ReplaceComparisonOperator == -> !=
   * Goal 38. Weak Mutation 14: collections.iterators.FilterIterator.setIterator(Ljava/util/Iterator;)V:130 - ReplaceConstant - 0 -> 1
   * Goal 39. Weak Mutation 16: collections.iterators.FilterIterator.setNextObject()Z:164 - ReplaceComparisonOperator == -> !=
   */
