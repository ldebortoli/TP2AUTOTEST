...
public class ListPopulation_ESTest extends ListPopulation_ESTest_scaffolding {
   ...
   * Goal 61. Weak Mutation 85: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - ReplaceComparisonOperator >= -> >
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setPopulationLimit((-1478));
  ...
  public void test02()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(455, 0.0);
      ...
      List<Double> list0 = RandomKey.identityPermutation(455);
      DummyRandomKey dummyRandomKey1 = new DummyRandomKey(list0);
      elitisticListPopulation0.addChromosome(dummyRandomKey1);
      DummyRandomKey dummyRandomKey2 = (DummyRandomKey)elitisticListPopulation0.getFittestChromosome();
      assertEquals(455, elitisticListPopulation0.getPopulationLimit());
      assertEquals(1, dummyRandomKey2.getLength());
  }
   ...
   * Goal 5. Branch math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - true in context: math.genetics.ListPopulation:addChromosomes(Ljava/util/Collection;)V
   * Goal 6. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 7. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 8. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 9. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 10. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 11. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 12. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   * Goal 13. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 98
   * Goal 14. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 102
   * Goal 15. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 103
   * Goal 16. [METHOD] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 17. [METHODNOEX] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   ...
   * Goal 40. Weak Mutation 45: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceComparisonOperator <= -> <
   */

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 1, 0.0);
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, (-6), (double) 1);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1164, 0.0);
      elitisticListPopulation0.getChromosomeList();
      assertEquals(1164, elitisticListPopulation0.getPopulationLimit());
  }
  ...
  public void test09()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(198, 0.9);
  ...
  public void test10()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1670, 0.0);
      // Undeclared exception!
      try { 
        elitisticListPopulation0.getFittestChromosome();
  ...
  public void test11()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(447, 0.0);
      // Undeclared exception!
      try { 
   ...
   * Goal 9. math.genetics.ListPopulation.setPopulationLimit(I)V: I19 Branch 11 IF_ICMPGE L178 - false
   * Goal 10. Branch math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: root-Branch in context: math.genetics.ListPopulation:getChromosomes()Ljava/util/List;
   * Goal 11. Branch math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - true in context: math.genetics.ListPopulation:addChromosomes(Ljava/util/Collection;)V
   ...
   * Goal 13. Branch math.genetics.ListPopulation.setPopulationLimit(I)V: I3 Branch 10 IFGT L175 - true in context: math.genetics.ListPopulation:setPopulationLimit(I)V
   * Goal 14. Branch math.genetics.ListPopulation.setPopulationLimit(I)V: I19 Branch 11 IF_ICMPGE L178 - false in context: math.genetics.ListPopulation:setPopulationLimit(I)V
   * Goal 15. setPopulationLimit(I)V_math.exception.MathIllegalNumberException_DECLARED
   ...
   * Goal 20. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 21. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 22. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 23. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   * Goal 24. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 129
   ...
   * Goal 27. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 98
   * Goal 28. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 102
   * Goal 29. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 103
   * Goal 30. math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: Line 110
   * Goal 31. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 175
   * Goal 32. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 178
   * Goal 33. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 179
   * Goal 34. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 35. [METHOD] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 36. [METHOD] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 37. [METHOD] math.genetics.ListPopulation.setPopulationLimit(I)V
   * Goal 38. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 39. [METHODNOEX] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 40. [METHODNOEX] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 41. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 42. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 43. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 44. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 45. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 46. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 47. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 48. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 49. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   * Goal 50. Weak Mutation 20: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp Negation of populationLimit
   * Goal 51. Weak Mutation 21: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC 1 populationLimit
   * Goal 52. Weak Mutation 22: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC -1 populationLimit
   * Goal 53. Weak Mutation 23: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp Negation of populationLimit
   * Goal 54. Weak Mutation 24: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC 1 populationLimit
   * Goal 55. Weak Mutation 25: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC -1 populationLimit
   * Goal 56. Weak Mutation 37: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> %
   * Goal 57. Weak Mutation 38: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> -
   * Goal 58. Weak Mutation 39: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> *
   * Goal 59. Weak Mutation 40: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> /
   * Goal 60. Weak Mutation 41: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp Negation
   * Goal 61. Weak Mutation 42: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp +1
   * Goal 62. Weak Mutation 43: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp -1
   * Goal 63. Weak Mutation 46: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceComparisonOperator <= -> ==
   * Goal 64. Weak Mutation 51: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp Negation
   * Goal 65. Weak Mutation 52: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp +1
   * Goal 66. Weak Mutation 53: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp -1
   * Goal 67. Weak Mutation 55: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - ReplaceComparisonOperator < -> -2
   * Goal 68. Weak Mutation 72: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp Negation of populationLimit
   * Goal 69. Weak Mutation 73: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp IINC 1 populationLimit
   * Goal 70. Weak Mutation 74: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp IINC -1 populationLimit
   * Goal 71. Weak Mutation 75: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - ReplaceComparisonOperator > -> -2
   * Goal 72. Weak Mutation 81: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - InsertUnaryOp Negation of populationLimit
   * Goal 73. Weak Mutation 82: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - InsertUnaryOp IINC 1 populationLimit
   * Goal 74. Weak Mutation 83: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - InsertUnaryOp IINC -1 populationLimit
   * Goal 75. Weak Mutation 84: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - ReplaceComparisonOperator >= -> -1
   * Goal 76. Weak Mutation 87: math.genetics.ListPopulation.setPopulationLimit(I)V:179 - InsertUnaryOp Negation of populationLimit
   * Goal 77. Weak Mutation 88: math.genetics.ListPopulation.setPopulationLimit(I)V:179 - InsertUnaryOp IINC 1 populationLimit
   * Goal 78. Weak Mutation 89: math.genetics.ListPopulation.setPopulationLimit(I)V:179 - InsertUnaryOp IINC -1 populationLimit
   * Goal 79. Weak Mutation 90: math.genetics.ListPopulation.setPopulationLimit(I)V:179 - ReplaceConstant - 1 -> 0
   */
  ...
  public void test13()  throws Throwable  {
      ...
      List<Double> list1 = RandomKey.identityPermutation(455);
      DummyRandomKey dummyRandomKey0 = new DummyRandomKey(list1);
      elitisticListPopulation0.addChromosome(dummyRandomKey0);
   ...
   * Goal 5. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: I3 Branch 4 IFNONNULL L80 - true
   * Goal 6. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: I16 Branch 5 IF_ICMPLE L83 - true
   * Goal 7. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - false
   * Goal 8. Branch math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: I3 Branch 4 IFNONNULL L80 - true in context: math.genetics.ListPopulation:setChromosomes(Ljava/util/List;)V
   * Goal 9. Branch math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: I16 Branch 5 IF_ICMPLE L83 - true in context: math.genetics.ListPopulation:setChromosomes(Ljava/util/List;)V
   * Goal 10. Branch math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - false in context: math.genetics.ListPopulation:addChromosomes(Ljava/util/Collection;)V
   ...
   * Goal 21. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 99
   * Goal 22. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: Line 100
   * Goal 23. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 80
   * Goal 24. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 83
   * Goal 25. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 87
   * Goal 26. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 88
   * Goal 27. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 89
   * Goal 28. [METHOD] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 29. [METHOD] math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V
   ...
   * Goal 50. Weak Mutation 31: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - ReplaceComparisonOperator <= -> <
   * Goal 51. Weak Mutation 37: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> %
   * Goal 52. Weak Mutation 38: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> -
   * Goal 53. Weak Mutation 39: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> *
   * Goal 54. Weak Mutation 40: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> /
   * Goal 55. Weak Mutation 41: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp Negation
   * Goal 56. Weak Mutation 42: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp +1
   * Goal 57. Weak Mutation 43: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp -1
   * Goal 58. Weak Mutation 44: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceComparisonOperator <= -> -1
   * Goal 59. Weak Mutation 47: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:100 - InsertUnaryOp Negation
   * Goal 60. Weak Mutation 48: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:100 - InsertUnaryOp +1
   * Goal 61. Weak Mutation 49: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:100 - InsertUnaryOp -1
   * Goal 62. Weak Mutation 50: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:100 - ReplaceConstant - 0 -> 1
   */
  ...
  public void test21()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 0, 1.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test22()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 39, (double) 39);
        fail("Expecting exception: IllegalArgumentException");
   ...
   * Goal 10. Branch math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - true in context: math.genetics.ListPopulation:addChromosomes(Ljava/util/Collection;)V
   * Goal 11. Branch math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: I7 Branch 7 IF_ICMPLT L129 - true in context: math.genetics.ListPopulation:addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 12. math.genetics.ListPopulation.<init>(I)V: Line 36
   * Goal 13. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 14. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 15. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 16. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 59
   * Goal 17. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 60
   * Goal 18. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 19. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 20. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 21. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   ...
   * Goal 28. math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: Line 110
   ...
   * Goal 32. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 33. [METHODNOEX] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   ...
   * Goal 43. Weak Mutation 13: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> -1
   * Goal 44. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   * Goal 45. Weak Mutation 16: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - InsertUnaryOp Negation of populationLimit
   * Goal 46. Weak Mutation 17: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - InsertUnaryOp IINC 1 populationLimit
   * Goal 47. Weak Mutation 18: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - InsertUnaryOp IINC -1 populationLimit
   * Goal 48. Weak Mutation 19: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - ReplaceConstant - 0 -> 1
   * Goal 49. Weak Mutation 20: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp Negation of populationLimit
   * Goal 50. Weak Mutation 21: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC 1 populationLimit
   * Goal 51. Weak Mutation 22: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC -1 populationLimit
   * Goal 52. Weak Mutation 23: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp Negation of populationLimit
   * Goal 53. Weak Mutation 24: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC 1 populationLimit
   * Goal 54. Weak Mutation 25: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC -1 populationLimit
   * Goal 55. Weak Mutation 37: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> %
   * Goal 56. Weak Mutation 38: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> -
   * Goal 57. Weak Mutation 39: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> *
   * Goal 58. Weak Mutation 40: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> /
   * Goal 59. Weak Mutation 41: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp Negation
   * Goal 60. Weak Mutation 42: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp +1
   * Goal 61. Weak Mutation 43: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp -1
   * Goal 62. Weak Mutation 46: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceComparisonOperator <= -> ==
   * Goal 63. Weak Mutation 51: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp Negation
   * Goal 64. Weak Mutation 52: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp +1
   * Goal 65. Weak Mutation 53: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp -1
   * Goal 66. Weak Mutation 55: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - ReplaceComparisonOperator < -> -2
   */
  ...
  public void test26()  throws Throwable  {
      ...
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list0, 1, 0.0);
        fail("Expecting exception: IllegalArgumentException");
