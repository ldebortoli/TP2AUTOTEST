...
public class ListPopulation_ESTest extends ListPopulation_ESTest_scaffolding {
   ...
   * Goal 4. math.genetics.ListPopulation.setPopulationLimit(I)V: I3 Branch 10 IFGT L175 - false
   * Goal 5. Branch math.genetics.ListPopulation.setPopulationLimit(I)V: I3 Branch 10 IFGT L175 - false in context: math.genetics.ListPopulation:setPopulationLimit(I)V
   * Goal 6. setPopulationLimit(I)V_math.exception.NumberIsTooSmallException_DECLARED
   ...
   * Goal 14. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 175
   * Goal 15. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 176
   * Goal 16. [METHOD] math.genetics.ListPopulation.setPopulationLimit(I)V
   * Goal 17. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 18. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 19. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 20. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 21. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 22. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 23. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 24. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 25. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   * Goal 26. Weak Mutation 20: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp Negation of populationLimit
   * Goal 27. Weak Mutation 21: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC 1 populationLimit
   * Goal 28. Weak Mutation 22: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC -1 populationLimit
   * Goal 29. Weak Mutation 23: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp Negation of populationLimit
   * Goal 30. Weak Mutation 24: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC 1 populationLimit
   * Goal 31. Weak Mutation 25: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC -1 populationLimit
   * Goal 32. Weak Mutation 72: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp Negation of populationLimit
   * Goal 33. Weak Mutation 73: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp IINC 1 populationLimit
   * Goal 34. Weak Mutation 74: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp IINC -1 populationLimit
   * Goal 35. Weak Mutation 77: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - ReplaceComparisonOperator > -> >=
   * Goal 36. Weak Mutation 78: math.genetics.ListPopulation.setPopulationLimit(I)V:176 - InsertUnaryOp Negation of populationLimit
   * Goal 37. Weak Mutation 79: math.genetics.ListPopulation.setPopulationLimit(I)V:176 - InsertUnaryOp IINC 1 populationLimit
   * Goal 38. Weak Mutation 80: math.genetics.ListPopulation.setPopulationLimit(I)V:176 - InsertUnaryOp IINC -1 populationLimit
   */

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 285, 0.9511770569417273);
      try { 
   ...
   * Goal 55. Weak Mutation 63: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:151 - ReplaceVariable chromosome -> bestChromosome
   * Goal 56. Weak Mutation 64: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:151 - ReplaceVariable bestChromosome -> chromosome
   * Goal 57. Weak Mutation 67: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:151 - ReplaceComparisonOperator <= -> <
   */

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1755, 0.3153223395347595);
      LinkedList<Integer> linkedList0 = new LinkedList<Integer>();
      DummyBinaryChromosome dummyBinaryChromosome0 = new DummyBinaryChromosome((List<Integer>) linkedList0);
      ...
      assertEquals(1755, elitisticListPopulation0.getPopulationLimit());
  }
   ...
   * Goal 3. math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: root-Branch
   * Goal 4. math.genetics.ListPopulation.getPopulationLimit()I: root-Branch
   * Goal 5. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I7 Branch 1 IFNONNULL L52 - true
   * Goal 6. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I17 Branch 2 IFGT L55 - true
   * Goal 7. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I32 Branch 3 IF_ICMPLE L58 - true
   * Goal 8. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - true
   * Goal 9. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: I7 Branch 7 IF_ICMPLT L129 - true
   * Goal 10. Branch math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;: root-Branch in context: 
   ...
   * Goal 29. math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: Line 110
   * Goal 30. math.genetics.ListPopulation.getPopulationLimit()I: Line 164
   * Goal 31. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 32. [METHOD] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 33. [METHOD] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 34. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 35. [METHODNOEX] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 36. [METHODNOEX] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   ...
   * Goal 59. Weak Mutation 45: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceComparisonOperator <= -> <
   ...
   * Goal 64. Weak Mutation 69: math.genetics.ListPopulation.getPopulationLimit()I:164 - InsertUnaryOp Negation
   * Goal 65. Weak Mutation 70: math.genetics.ListPopulation.getPopulationLimit()I:164 - InsertUnaryOp +1
   * Goal 66. Weak Mutation 71: math.genetics.ListPopulation.getPopulationLimit()I:164 - InsertUnaryOp -1
   */
   ...
   * Goal 9. Branch math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: root-Branch in context: math.genetics.ListPopulation:getChromosomes()Ljava/util/List;
   ...
   * Goal 13. math.genetics.ListPopulation.<init>(I)V: Line 36
   * Goal 14. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 15. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 16. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 17. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 18. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 19. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 20. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   * Goal 21. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 129
   * Goal 22. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 133
   * Goal 23. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 134
   * Goal 24. math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: Line 110
   * Goal 25. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 80
   * Goal 26. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 83
   * Goal 27. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 87
   * Goal 28. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 88
   * Goal 29. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 89
   * Goal 30. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 31. [METHOD] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 32. [METHOD] math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V
   * Goal 33. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 34. [METHODNOEX] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 35. [METHODNOEX] math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V
   * Goal 36. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 37. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 38. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 39. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 40. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 41. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 42. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 43. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 44. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   * Goal 45. Weak Mutation 20: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp Negation of populationLimit
   * Goal 46. Weak Mutation 21: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC 1 populationLimit
   * Goal 47. Weak Mutation 22: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC -1 populationLimit
   * Goal 48. Weak Mutation 23: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp Negation of populationLimit
   * Goal 49. Weak Mutation 24: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC 1 populationLimit
   * Goal 50. Weak Mutation 25: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC -1 populationLimit
   * Goal 51. Weak Mutation 26: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:80 - ReplaceComparisonOperator != null -> = null
   * Goal 52. Weak Mutation 27: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - InsertUnaryOp Negation
   * Goal 53. Weak Mutation 28: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - InsertUnaryOp +1
   * Goal 54. Weak Mutation 29: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - InsertUnaryOp -1
   * Goal 55. Weak Mutation 31: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - ReplaceComparisonOperator <= -> <
   * Goal 56. Weak Mutation 51: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp Negation
   * Goal 57. Weak Mutation 52: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp +1
   * Goal 58. Weak Mutation 53: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp -1
   * Goal 59. Weak Mutation 55: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - ReplaceComparisonOperator < -> -2
   */
  ...
  public void test06()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(0, 158);
        fail("Expecting exception: IllegalArgumentException");
   ...
   * Goal 4. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I32 Branch 3 IF_ICMPLE L58 - true
   * Goal 5. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: I7 Branch 7 IF_ICMPLT L129 - true
   * Goal 6. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - false
   ...
   * Goal 8. Branch math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - false in context: math.genetics.ListPopulation:getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 9. getFittestChromosome()Lmath/genetics/Chromosome;_java.lang.NullPointerException_IMPLICIT
   * Goal 10. math.genetics.ListPopulation.<init>(I)V: Line 36
   * Goal 11. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 12. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 13. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   ...
   * Goal 19. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 133
   * Goal 20. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 134
   * Goal 21. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 149
   * Goal 22. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 150
   * Goal 23. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 151
   * Goal 24. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 25. [METHOD] math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 26. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 27. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 28. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 29. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 30. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   ...
   * Goal 44. Weak Mutation 53: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp -1
   * Goal 45. Weak Mutation 55: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - ReplaceComparisonOperator < -> -2
   * Goal 46. Weak Mutation 61: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:149 - ReplaceConstant - 0 -> 1
   * Goal 47. Weak Mutation 62: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:150 - ReplaceComparisonOperator == -> !=
   */
  ...
  public void test11()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(355, 0.9);
      // Undeclared exception!
      try { 
  ...
  public void test13()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1, 1);
      try { 
        elitisticListPopulation0.setPopulationLimit((-2343));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test14()  throws Throwable  {
      ...
      DummyRandomKey dummyRandomKey0 = new DummyRandomKey((List<Double>) linkedList0);
   ...
   * Goal 4. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I17 Branch 2 IFGT L55 - true
   * Goal 5. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I32 Branch 3 IF_ICMPLE L58 - true
   * Goal 6. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I32 Branch 3 IF_ICMPLE L58 - false
   * Goal 7. math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V: I10 Branch 6 IF_ICMPLE L98 - true
   * Goal 8. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: I7 Branch 7 IF_ICMPLT L129 - true
   ...
   * Goal 16. math.genetics.ListPopulation.<init>(I)V: Line 36
   * Goal 17. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 18. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 19. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 20. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 59
   * Goal 21. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 60
   ...
   * Goal 35. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 181
   * Goal 36. math.genetics.ListPopulation.setPopulationLimit(I)V: Line 182
   * Goal 37. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 38. [METHOD] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 39. [METHOD] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 40. [METHOD] math.genetics.ListPopulation.setPopulationLimit(I)V
   * Goal 41. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 42. [METHODNOEX] math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V
   * Goal 43. [METHODNOEX] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 44. [METHODNOEX] math.genetics.ListPopulation.setPopulationLimit(I)V
   * Goal 45. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 46. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 47. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 48. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 49. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 50. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 51. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 52. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 53. Weak Mutation 13: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> -1
   * Goal 54. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   * Goal 55. Weak Mutation 16: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - InsertUnaryOp Negation of populationLimit
   * Goal 56. Weak Mutation 17: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - InsertUnaryOp IINC 1 populationLimit
   * Goal 57. Weak Mutation 18: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - InsertUnaryOp IINC -1 populationLimit
   * Goal 58. Weak Mutation 19: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:60 - ReplaceConstant - 0 -> 1
   * Goal 59. Weak Mutation 20: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp Negation of populationLimit
   * Goal 60. Weak Mutation 21: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC 1 populationLimit
   * Goal 61. Weak Mutation 22: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC -1 populationLimit
   * Goal 62. Weak Mutation 23: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp Negation of populationLimit
   * Goal 63. Weak Mutation 24: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC 1 populationLimit
   * Goal 64. Weak Mutation 25: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC -1 populationLimit
   * Goal 65. Weak Mutation 37: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> %
   * Goal 66. Weak Mutation 38: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> -
   * Goal 67. Weak Mutation 39: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> *
   * Goal 68. Weak Mutation 40: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceArithmeticOperator + -> /
   * Goal 69. Weak Mutation 41: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp Negation
   * Goal 70. Weak Mutation 42: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp +1
   * Goal 71. Weak Mutation 43: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - InsertUnaryOp -1
   * Goal 72. Weak Mutation 46: math.genetics.ListPopulation.addChromosomes(Ljava/util/Collection;)V:98 - ReplaceComparisonOperator <= -> ==
   * Goal 73. Weak Mutation 51: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp Negation
   * Goal 74. Weak Mutation 52: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp +1
   * Goal 75. Weak Mutation 53: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp -1
   * Goal 76. Weak Mutation 55: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - ReplaceComparisonOperator < -> -2
   * Goal 77. Weak Mutation 72: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp Negation of populationLimit
   * Goal 78. Weak Mutation 73: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp IINC 1 populationLimit
   * Goal 79. Weak Mutation 74: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - InsertUnaryOp IINC -1 populationLimit
   * Goal 80. Weak Mutation 75: math.genetics.ListPopulation.setPopulationLimit(I)V:175 - ReplaceComparisonOperator > -> -2
   * Goal 81. Weak Mutation 81: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - InsertUnaryOp Negation of populationLimit
   * Goal 82. Weak Mutation 82: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - InsertUnaryOp IINC 1 populationLimit
   * Goal 83. Weak Mutation 83: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - InsertUnaryOp IINC -1 populationLimit
   * Goal 84. Weak Mutation 86: math.genetics.ListPopulation.setPopulationLimit(I)V:178 - ReplaceComparisonOperator >= -> ==
   * Goal 85. Weak Mutation 91: math.genetics.ListPopulation.setPopulationLimit(I)V:181 - InsertUnaryOp Negation of populationLimit
   * Goal 86. Weak Mutation 92: math.genetics.ListPopulation.setPopulationLimit(I)V:181 - InsertUnaryOp IINC 1 populationLimit
   * Goal 87. Weak Mutation 93: math.genetics.ListPopulation.setPopulationLimit(I)V:181 - InsertUnaryOp IINC -1 populationLimit
   */
  ...
  public void test18()  throws Throwable  {
      ...
      DummyRandomKey dummyRandomKey0 = new DummyRandomKey(list0);
      elitisticListPopulation0.addChromosome(dummyRandomKey0);
      elitisticListPopulation0.setPopulationLimit(4);
      List<Chromosome> list1 = elitisticListPopulation0.getChromosomes();
      elitisticListPopulation0.addChromosomes(list1);
      ElitisticListPopulation elitisticListPopulation1 = null;
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list1, 1, 965.0);
        fail("Expecting exception: IllegalArgumentException");
   ...
   * Goal 3. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I7 Branch 1 IFNONNULL L52 - true
   * Goal 4. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I17 Branch 2 IFGT L55 - true
   * Goal 5. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I17 Branch 2 IFGT L55 - false
   * Goal 6. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I32 Branch 3 IF_ICMPLE L58 - true
   * Goal 7. Branch math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;: root-Branch in context: 
   * Goal 8. [Output]: math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;:NonNull:java.util.List:isEmpty()Z:True
   * Goal 9. [Output]: math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;:NonNull:java.util.List:size()I:Zero
   * Goal 10. math.genetics.ListPopulation.<init>(I)V: Line 36
   * Goal 11. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 12. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 13. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 56
   * Goal 14. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 15. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 16. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 17. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 18. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   * Goal 19. math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;: Line 118
   * Goal 20. [METHOD] math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;
   * Goal 21. [METHODNOEX] math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;
   * Goal 22. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 23. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 24. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 25. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 26. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 27. Weak Mutation 5: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> !=
   * Goal 28. Weak Mutation 7: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:56 - InsertUnaryOp Negation of populationLimit
   * Goal 29. Weak Mutation 8: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:56 - InsertUnaryOp IINC 1 populationLimit
   * Goal 30. Weak Mutation 9: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:56 - InsertUnaryOp IINC -1 populationLimit
   * Goal 31. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 32. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 33. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 34. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
  ...
  public void test19()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(236, 0.0);
      List<Chromosome> list0 = elitisticListPopulation0.getChromosomeList();
      ElitisticListPopulation elitisticListPopulation1 = null;
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list0, (-1736), 0.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test20()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 2677, (double) 2677);
        fail("Expecting exception: IllegalArgumentException");
