...
public class ListPopulation_ESTest extends ListPopulation_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setPopulationLimit((-3205));
   ...
   * Goal 9. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - true
   * Goal 10. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - false
   * Goal 11. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I27 Branch 9 IFLE L151 - true
   * Goal 12. Branch math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: root-Branch in context: math.genetics.ListPopulation:getChromosomes()Ljava/util/List;
   * Goal 13. Branch math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: I3 Branch 4 IFNONNULL L80 - true in context: math.genetics.ListPopulation:setChromosomes(Ljava/util/List;)V
   * Goal 14. Branch math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: I16 Branch 5 IF_ICMPLE L83 - true in context: math.genetics.ListPopulation:setChromosomes(Ljava/util/List;)V
   * Goal 15. Branch math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: I7 Branch 7 IF_ICMPLT L129 - true in context: math.genetics.ListPopulation:addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 16. Branch math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - true in context: math.genetics.ListPopulation:getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 17. Branch math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - false in context: math.genetics.ListPopulation:getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 18. Branch math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I27 Branch 9 IFLE L151 - true in context: math.genetics.ListPopulation:getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 19. [Output]: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:NonNull:math.genetics.Chromosome:fitness()D:Zero
   * Goal 20. math.genetics.ListPopulation.<init>(I)V: Line 36
   * Goal 21. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 22. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 23. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 24. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 25. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 26. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 27. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   * Goal 28. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 129
   * Goal 29. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 133
   * Goal 30. math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V: Line 134
   * Goal 31. math.genetics.ListPopulation.getChromosomes()Ljava/util/List;: Line 110
   * Goal 32. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 149
   * Goal 33. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 150
   * Goal 34. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 151
   * Goal 35. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 155
   * Goal 36. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 156
   * Goal 37. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 80
   * Goal 38. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 83
   * Goal 39. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 87
   * Goal 40. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 88
   * Goal 41. math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V: Line 89
   * Goal 42. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 43. [METHOD] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 44. [METHOD] math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 45. [METHOD] math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V
   * Goal 46. [METHODNOEX] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   * Goal 47. [METHODNOEX] math.genetics.ListPopulation.getChromosomes()Ljava/util/List;
   * Goal 48. [METHODNOEX] math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 49. [METHODNOEX] math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V
   * Goal 50. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 51. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 52. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 53. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 54. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 55. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 56. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 57. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 58. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   ...
   * Goal 65. Weak Mutation 26: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:80 - ReplaceComparisonOperator != null -> = null
   * Goal 66. Weak Mutation 27: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - InsertUnaryOp Negation
   * Goal 67. Weak Mutation 28: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - InsertUnaryOp +1
   * Goal 68. Weak Mutation 29: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - InsertUnaryOp -1
   * Goal 69. Weak Mutation 32: math.genetics.ListPopulation.setChromosomes(Ljava/util/List;)V:83 - ReplaceComparisonOperator <= -> ==
   * Goal 70. Weak Mutation 51: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp Negation
   * Goal 71. Weak Mutation 52: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp +1
   * Goal 72. Weak Mutation 53: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - InsertUnaryOp -1
   * Goal 73. Weak Mutation 55: math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V:129 - ReplaceComparisonOperator < -> -2
   * Goal 74. Weak Mutation 61: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:149 - ReplaceConstant - 0 -> 1
   * Goal 75. Weak Mutation 62: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:150 - ReplaceComparisonOperator == -> !=
   * Goal 76. Weak Mutation 63: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:151 - ReplaceVariable chromosome -> bestChromosome
   * Goal 77. Weak Mutation 64: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:151 - ReplaceVariable bestChromosome -> chromosome
   * Goal 78. Weak Mutation 67: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:151 - ReplaceComparisonOperator <= -> <
   */

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(83, 0.37145482964616794);
      ElitisticListPopulation elitisticListPopulation1 = new ElitisticListPopulation(83, 0.11596259030215682);
      List<Chromosome> list0 = elitisticListPopulation1.getChromosomes();
      Integer[] integerArray0 = new Integer[0];
      DummyListChromosome dummyListChromosome0 = new DummyListChromosome(integerArray0);
      elitisticListPopulation1.addChromosome(dummyListChromosome0);
      LinkedList<Double> linkedList0 = new LinkedList<Double>();
      DummyRandomKey dummyRandomKey0 = new DummyRandomKey((List<Double>) linkedList0);
      elitisticListPopulation1.addChromosome(dummyRandomKey0);
      elitisticListPopulation0.setChromosomes(list0);
      elitisticListPopulation0.getFittestChromosome();
      assertEquals(83, elitisticListPopulation0.getPopulationLimit());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 1, (-1636.0758350317315));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-1,636.076)
         //
  ...
  public void test07()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(3310, 1.0);
      elitisticListPopulation0.iterator();
      assertEquals(3310, elitisticListPopulation0.getPopulationLimit());
  }
   ...
   * Goal 7. Branch math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: I17 Branch 8 IFEQ L150 - false in context: math.genetics.ListPopulation:getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 8. getFittestChromosome()Lmath/genetics/Chromosome;_java.lang.NullPointerException_IMPLICIT
   * Goal 9. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 10. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 11. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 12. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   ...
   * Goal 19. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 149
   * Goal 20. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 150
   * Goal 21. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 151
   * Goal 22. [METHOD] math.genetics.ListPopulation.addChromosome(Lmath/genetics/Chromosome;)V
   ...
   * Goal 44. Weak Mutation 61: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:149 - ReplaceConstant - 0 -> 1
   * Goal 45. Weak Mutation 62: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:150 - ReplaceComparisonOperator == -> !=
   */

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 1577, 3.145894820876798E-6);
   ...
   * Goal 2. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I17 Branch 2 IFGT L55 - true
   * Goal 3. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: I32 Branch 3 IF_ICMPLE L58 - true
   * Goal 4. getFittestChromosome()Lmath/genetics/Chromosome;_java.lang.IndexOutOfBoundsException_IMPLICIT
   * Goal 5. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 52
   * Goal 6. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 55
   * Goal 7. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 58
   * Goal 8. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 62
   * Goal 9. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 63
   * Goal 10. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 64
   * Goal 11. math.genetics.ListPopulation.<init>(Ljava/util/List;I)V: Line 65
   * Goal 12. math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;: Line 149
   * Goal 13. [METHOD] math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;
   * Goal 14. Weak Mutation 0: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:52 - ReplaceComparisonOperator != null -> = null
   * Goal 15. Weak Mutation 1: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp Negation of populationLimit
   * Goal 16. Weak Mutation 2: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC 1 populationLimit
   * Goal 17. Weak Mutation 3: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - InsertUnaryOp IINC -1 populationLimit
   * Goal 18. Weak Mutation 4: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:55 - ReplaceComparisonOperator > -> -2
   * Goal 19. Weak Mutation 10: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp Negation of populationLimit
   * Goal 20. Weak Mutation 11: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC 1 populationLimit
   * Goal 21. Weak Mutation 12: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - InsertUnaryOp IINC -1 populationLimit
   * Goal 22. Weak Mutation 15: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:58 - ReplaceComparisonOperator <= -> ==
   * Goal 23. Weak Mutation 20: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp Negation of populationLimit
   * Goal 24. Weak Mutation 21: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC 1 populationLimit
   * Goal 25. Weak Mutation 22: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:62 - InsertUnaryOp IINC -1 populationLimit
   * Goal 26. Weak Mutation 23: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp Negation of populationLimit
   * Goal 27. Weak Mutation 24: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC 1 populationLimit
   * Goal 28. Weak Mutation 25: math.genetics.ListPopulation.<init>(Ljava/util/List;I)V:63 - InsertUnaryOp IINC -1 populationLimit
   * Goal 29. Weak Mutation 61: math.genetics.ListPopulation.getFittestChromosome()Lmath/genetics/Chromosome;:149 - ReplaceConstant - 0 -> 1
   */

  @Test(timeout = 4000)
  public void test10()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 2679, 0.0);
      // Undeclared exception!
      try { 
        elitisticListPopulation0.getFittestChromosome();
  ...
  public void test11()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(146, 1.0);
      // Undeclared exception!
      try { 
  ...
  public void test12()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(2054, 0.9);
      try { 
   ...
   * Goal 12. [Output]: math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;:NonNull:java.util.List:isEmpty()Z:False
   * Goal 13. [Output]: math.genetics.ListPopulation.getChromosomeList()Ljava/util/List;:NonNull:java.util.List:size()I:Positive
  ...
  public void test18()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) linkedList0, 1569, 0.0);
      try { 
  ...
  public void test20()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, (-2001), (double) (-2001));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test24()  throws Throwable  {
      ...
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list0, (-2743), (double) 83);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test25()  throws Throwable  {
      ...
      assertEquals(2054, elitisticListPopulation0.getPopulationLimit());
  }
}
